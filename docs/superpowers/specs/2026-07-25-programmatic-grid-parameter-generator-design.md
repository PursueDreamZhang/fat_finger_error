...
> 2026-07-27 更新：本文保留为阶段 1–6 的历史设计与验收记录。当前生成器输出 P50/P70/P85 与两档 W、两档 S 的 T/W/D/S 组合，但不再输出统计报告或回放准备产物；以 `docs/programmatic_parameter_generator_guide.md` 为现行契约。
